...
main:
    ...
    // Add two square matrices of size 3*3. 
...
loop2:
    ...
    ldr    w7, [x9, x4, lsl 2]
    // Add the value in w5(from Matrix A) with value in w7(from Matrix B) and store the result in w5
    add    w5, w5, w7
    // Store the sum in register w5 to Matrix-C
    str    w5, [x8, x4, lsl 2]
